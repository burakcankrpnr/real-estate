...
export const metadata: Metadata = {
  title: "Satılık Apartman Dairesi İlanları | Tüzgen Group",
  description: "Satılık apartman dairesi ilanlarını inceleyebilir, detaylı bilgi alabilirsiniz.",
};

async function getProperties() {
  try {
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/api/properties?type=konut&subtype=apartman-dairesi&status=satilik&limit=12`,
...
export default async function SatilikApartmanDairesiPage() {
  const properties: Property[] = await getProperties();

  return (
    <>
      <Breadcrumb
        pageName="Satılık Apartman Dairesi İlanları"
        description="Satılık apartman dairesi ilanlarını inceleyin, size uygun daireyi bulun."
      />
                      ...
                      <div className="flex flex-wrap justify-between">
                        ...
                        <span className="mb-2 flex items-center text-base font-medium text-body-color">
                          <span className="mr-2">
                            ...
                            >
                              <path
                                d="M10.5 10.5C10.5 10.9033 10.3314 11.2889 10.0314 11.5889C9.73137 11.8889 9.34572 12.0575 8.94238 12.0575C8.53904 12.0575 8.15339 11.8889 7.85338 11.5889C7.55337 11.2889 7.38477 10.9033 7.38477 10.5C7.38477 10.0966 7.55337 9.71101 7.85338 9.41101C8.15339 9.111 8.53904 8.94239 8.94238 8.94239C9.34572 8.94239 9.73137 9.111 10.0314 9.41101C10.3314 9.71101 10.5 10.0966 10.5 10.5ZM3.5 4.66667C3.5 5.07001 3.33139 5.45566 3.03139 5.75566C2.73138 6.05567 2.34573 6.22428 1.94239 6.22428C1.53905 6.22428 1.1534 6.05567 0.853395 5.75566C0.55339 5.45566 0.384781 5.07001 0.384781 4.66667C0.384781 4.26333 0.55339 3.87768 0.853395 3.57767C1.1534 3.27767 1.53905 3.10906 1.94239 3.10906C2.34573 3.10906 2.73138 3.27767 3.03139 3.57767C3.33139 3.87768 3.5 4.26333 3.5 4.66667ZM12.0576 1.94239C12.0576 2.34573 11.889 2.73138 11.589 3.03139C11.289 3.33139 10.9033 3.5 10.5 3.5C10.0967 3.5 9.71103 3.33139 9.41103 3.03139C9.11102 2.73138 8.94241 2.34573 8.94241 1.94239C8.94241 1.53905 9.11102 1.1534 9.41103 0.853394C9.71103 0.553389 10.0967 0.38478 10.5 0.38478C10.9033 0.38478 11.289 0.553389 11.589 0.853394C11.889 1.1534 12.0576 1.53905 12.0576 1.94239ZM13.6152 10.5C13.6152 11.7178 12.9797 12.8435 11.9581 13.4554C10.9365 14.0673 9.69忠 14.1295 8.61蠱 13.6182L5.38869 13.6182C4.31蠱 14.1295 3.06蠱 14.0673 2.04忠 13.4554C1.02忠 12.8435 0.38478 11.7178 0.38478 10.5L0.38478 10.5C0.38478 9.28217 1.02蠱 8.15654 2.04忠 7.54464C3.06蠱 6.93274 4.31蠱 6.87049 5.38869 7.38184L8.61蠱 7.38184C9.69忠 6.87049 10.9365 6.93274 11.9581 7.54464C12.9797 8.15654 13.6152 9.28217 13.6152 10.5Z"
                                fill="currentColor"
                              ></path>
                            </svg>
                          </span>
