...
export const metadata: Metadata = {
  title: "Satılık Villa İlanları | Tüzgen Group",
  description: "Satılık villa ilanlarını inceleyin, bütçenize uygun villayı bulun.",
};

async function getProperties() {
  try {
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/api/properties?type=konut&subtype=villa&status=satilik&limit=12`,
...
export default async function SatilikVillaPage() {
  ...
  return (
    <>
      <Breadcrumb
        pageName="Satılık Villa İlanları"
        description="Satılık villa ilanlarını inceleyin, bütçenize ve tarzınıza uygun villayı bulun."
      />
