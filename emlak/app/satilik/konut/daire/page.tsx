...
export const metadata: Metadata = {
  title: "Satılık Daire İlanları | Tüzgen Group",
  description: "Satılık daire ilanlarını inceleyin, bütçenize uygun daireyi bulun.",
};

async function getProperties() {
  try {
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/api/properties?type=konut&subtype=daire&status=satilik&limit=12`,
...
export default async function SatilikDairePage() {
  ...
  return (
    <>
      <Breadcrumb
        pageName="Satılık Daire İlanları"
        description="Satılık daire ilanlarını inceleyin, bütçenize ve tarzınıza uygun daireyi bulun."
      />
