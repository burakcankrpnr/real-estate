...
export const metadata: Metadata = {
  ...
  description: "Satılık arsa, tarla, bahçe ve diğer arazi ilanlarını keşfedin.",
};

async function getProperties() {
  try {
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/api/properties?category=arsa&status=satilik&limit=24`,
