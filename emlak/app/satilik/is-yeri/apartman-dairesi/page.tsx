...
export const metadata: Metadata = {
  ...
  description: "Satılık apartman dairesi ilanlarını inceleyebilir, ticari yatırım fırsatlarını değerlendirebilirsiniz.",
};

async function getProperties() {
  try {
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/api/properties?category=is-yeri&status=satilik&type=apartman-dairesi&limit=24`,
  ...
  return (
    <>
      <Breadcrumb
        ...
        description="Satılık apartman dairesi ilanlarını inceleyin ve ticari yatırım fırsatlarını değerlendirin."
      />
          ...
          <div className="flex flex-wrap justify-between">
            <div className="mb-8 w-full">
              <h2 className="text-2xl font-bold text-black dark:text-white">
                Satılık Apartman Dairesi İlanları
              </h2>
            </div>
          </div>
