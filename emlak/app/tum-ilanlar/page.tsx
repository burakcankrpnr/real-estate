...
export const metadata: Metadata = {
  title: "Tüm Emlak İlanları | Tüzgen Group",
  description: "Satılık ve kiralık tüm emlak ilanlarını inceleyin, hayalinizdeki mülkü bulun.",
};

async function getProperties() {
  try {
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/api/properties?limit=24`,
