    ...
    const fetchOffices = async () => {
      ...
      try {
        ...
        const mockOffices: Office[] = [
          {
            _id: "1",
            name: "Emlak Merkez Ofisi",
            email: "merkez@orneksite.com",
            phone: "+90 212 555 1234",
            address: "Bağdat Caddesi No:123",
            city: "İstanbul",
            district: "Kadıköy",
            description: "İstanbul'un kalbinde 1998'den beri hizmet veren köklü emlak ofisimiz, lüks konut ve ticari gayrimenkul alanında uzmanlaşmıştır.",
            image: "/favicon.ico",
            website: "https://merkezofisi.com",
            socialMedia: {
              facebook: "emlakmerkez",
              instagram: "emlak_merkez",
              twitter: "emlakmerkez"
            },
            workingHours: {
          ...
          },
          {
            ...
            email: "info@prestijgayrimenkul.com",
            phone: "+90 216 555 6789",
            address: "Bağdat Caddesi No:456",
            city: "İstanbul",
            district: "Ataşehir",
            description: "Lüks rezidans ve villa satışında uzmanlaşmış, İstanbul'un en prestijli projelerini portföyünde bulunduran gayrimenkul danışmanlığı şirketi.",
            image: "/favicon.ico",
            website: "https://prestijgayrimenkul.com",
            socialMedia: {
              instagram: "prestij_gayrimenkul",
              twitter: "prestijre"
            },
            workingHours: {
          ...
          {
            _id: "3",
            name: "Ankara Emlak Danışmanlık",
            email: "iletisim@ankaraemkak.com",
            phone: "+90 312 555 9876",
            address: "Tunalı Hilmi Cad. No:78",
            city: "Ankara",
            district: "Çankaya",
            description: "Ankara'nın en köklü emlak danışmanlık firması. Konut, ticari gayrimenkul ve arsa alanlarında geniş portföy ve uzman kadro.",
            image: "/favicon.ico",
            socialMedia: {
              facebook: "ankaraemkak",
              instagram: "ankara_emlak"
            },
            workingHours: {
          ...
          {
            _id: "4",
            name: "Ege Emlak Yatırım",
            email: "bilgi@egeemlakyatirim.com",
            phone: "+90 232 555 4567",
            address: "Alsancak Mah. Kordon No:34",
            city: "İzmir",
            district: "Konak",
            description: "İzmir'in öncü emlak yatırım ve danışmanlık şirketi. Yazlık, konut ve ticari portföyümüzle Ege Bölgesi'nde hizmet vermekteyiz.",
            image: "/favicon.ico",
            website: "https://egeemlakyatirim.com",
            socialMedia: {
              facebook: "egeemlakyatirim",
              instagram: "ege_emlak_yatirim",
              twitter: "egeemlakyatirim"
            },
            workingHours: {
