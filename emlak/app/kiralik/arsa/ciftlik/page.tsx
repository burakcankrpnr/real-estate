...
export const metadata: Metadata = {
  ...
  description: "Kiralık çiftlik ilanlarını inceleyebilir, uygun şartlarla çiftlik kiralama fırsatlarını değerlendirebilirsiniz.",
};

async function getProperties() {
  try {
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/api/properties?category=arsa&status=kiralik&type=ciftlik&limit=24`,
...
export default async function KiralikCiftlikPage() {
  ...
  return (
    <>
      <Breadcrumb
        ...
        description="Kiralık çiftlik ilanlarını inceleyin ve çiftlik kiralama fırsatlarını değerlendirin."
      />
