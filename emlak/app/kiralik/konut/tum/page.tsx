...
export const metadata: Metadata = {
  title: "Tüm Kiralık Konut İlanları | Tüzgen Group",
  description: "Kiralık daire, villa, müstakil ev ve diğer konut ilanlarını inceleyebilirsiniz.",
};
...
export default async function TumKiralikKonutPage() {
  const properties: Property[] = await getProperties();

  return (
    <>
      <Breadcrumb
        pageName="Kiralık Konut İlanları"
        description="Tüm kiralık konut ilanlarını inceleyin, size uygun evi bulun."
      />
