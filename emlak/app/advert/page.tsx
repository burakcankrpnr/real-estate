...
export const metadata: Metadata = {
  title: "İlanlarımız | Tüzgen Group",
  description: "İlanlarımızı inceleyin. Emlak işlemleri, mülk alım-satım ve kiralama hakkında her türlü sorunuz için bizimle iletişime geçebilirsiniz.",
  // other metadata
};
