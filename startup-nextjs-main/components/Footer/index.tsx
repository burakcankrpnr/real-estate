            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <p className="dark:text-body-color-dark mb-9 text-base leading-relaxed text-body-color">
                  Türkiye'nin en güvenilir emlak platformu olarak, yatırımcılar, alıcılar ve satıcılar için geniş bir hizmet yelpazesi sunuyoruz. 36 profesyonel ekibimizle, emlak dünyasında her türlü ihtiyaca çözüm üretiyoruz.
                </p>
